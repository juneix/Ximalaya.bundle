...
XIMALAYA_SEARCH_BY_ALBUM = 'https://www.ximalaya.com/revision/search?core=album&kw={kw}&page={page}&rows=20&condition=relation'
XIMALAYA_SEARCH_TRACK = 'https://www.ximalaya.com/revision/search?core=track&kw={kw}&page={page}&rows=20&condition=relation'
